                    ...
                    <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        ...
                        <div class="card-body z-3 px-md-0 px-lg-4">
                            ...
                            <div class="card-body z-3 px-md-0 px-lg-4">
                                ...
                                <p class="text-center">Masukkan nomor HP yang terdaftar (contoh: 0812xxxx)</p>

                                <form method="POST" action="{{ route('forgot.phone.send') }}">
                                    @csrf
                                    ...
                                    <p class="mt-3 text-center">
                                        Kembali ke <a href="{{ route('forgot.choose') }}">Choose</a>
                                    </p>
                                </form>
                            </div>
