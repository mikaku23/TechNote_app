...
<head>
    ...
    <title>Verifikasi - TechNoteApp</title>
                ...
                <div class="col-md-4 offset-md-4">
                    <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        ...
                        <div class="card-body z-3 px-md-0 px-lg-4">
                            ...
                            <h2 class="mb-2 text-center">Verifikasi Keamanan</h2>
                            <p class="text-center">{{ $user->security_question }}</p>

                            <form method="POST" action="{{ route('forgot-check-answer') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="security_answer" value="" class="form-control" placeholder="Masukkan jawaban">
                                </div>
                                ...
                                <p class="mt-3 text-center">
                                    Kembali ke <a href="{{ route('forgot-password') }}">Lupa Password</a>
                                </p>
                            </form>
