...
<section class="card-hero glass-card about-section">
    ...
    <div class="about-content" style="text-align: justify;">
        <p>
            TechNote App dirancang untuk memudahkan mahasiswa dalam melakukan pendataan penginstalan software,
        ...
        <p>
            ...
            update status perangkat, dan histori perbaikan dirancang agar intuitif bagi pengguna, baik mahasiswa,
